...
val perfPaths = Seq("dbfs:/mortgage/raw/2000-2001/perf")
val acqPaths = Seq("dbfs:/mortgage/raw/2000-2001/acq")
val output = "dbfs:/mortgage/etled/2000-2001"

val rawDF = XGBoostETL.csv(spark, perfPaths, acqPaths, false)
rawDF.write.mode("overwrite").parquet(output)
